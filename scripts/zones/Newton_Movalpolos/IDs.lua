...
zones[xi.zone.NEWTON_MOVALPOLOS] =
{
    text =
    {
        ...
        COME_CLOSER                   = 7241, -- H0000! C0mE cL0SEr! C0mE cL0SEr! CAn'T TrAdE fr0m S0 fAr AwAy!
        MINING_IS_POSSIBLE_HERE       = 7249, -- Mining is possible here if you have <item>.
        CHEST_UNLOCKED                = 7264, -- You unlock the chest!
        COLLECTOR_SPAWN               = 7273, -- You gently place the <item> on the ground. Suddenly, you hear the clanging sound of armor approaching. It looks like someone is interested in the <item>...
        SHOWMAN_DECLINE               = 7275, -- ... Me no want that. Thing me want not here! It not being here!!!
        SHOWMAN_TRIGGER               = 7276, -- Hey, you there! Muscles nice. You want fight strong one? It cost you. Give me nice item.
